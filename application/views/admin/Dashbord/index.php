	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">shie_ms 管理画面</a>
			</div>
			<!-- /.navbar-header -->
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="<?php print $this->url->site_url('admin/auth/edit_user/'.$this->user->id); ?>"><i class="fa fa-user fa-fw"></i> プロフィール</a>
						</li>
						<li><a href="<?php print $this->url->site_url('admin/auth'); ?>"><i class="fa fa-gear fa-fw"></i> ユーザー一覧</a>
						</li>
						<li class="divider"></li>
					...
					<ul class="nav" id="side-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="flot.html">一覧</a>
								</li>
								<li>
									<a href="morris.html">新規作成</a>
								</li>
								<li>
									<a href="morris.html">ブログ-カテゴリ</a>
								</li>
							</ul>
							<!-- /.nav-second-level -->
						</li>
...
<a href="<?php  print $this->url->site_url('admin/blog'); ?>">記事一覧</a>