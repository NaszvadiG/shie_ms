...
class Auth extends AdminController {
	...
	public function login()
	{
		...
		//validate form input
		$this->form_validation->set_rules('identity', 'メールアドレス', 'required',array('required' => 'メールアドレスを入力してください'));
		$this->form_validation->set_rules('password', 'パスワード', 'required',array('required' => 'パスワードを入力してください'));
		...
		else
		{
			...
			// set the flash data error message if there is one
			$this->data['message']['root'] = $this->session->flashdata('message');
			$keyName = array('identity','password');
			foreach($keyName as $row){
				$this->data['message'][$row] = $this->form_validation->error($row);
			}
